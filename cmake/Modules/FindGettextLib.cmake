...
if(GETTEXTLIB_FOUND)
	...
	file(GLOB _GETTEXT_LOCALE_ENTRIES RELATIVE ${GETTEXT_PO_PATH} "${GETTEXT_PO_PATH}/*")
	foreach(_locale ${_GETTEXT_LOCALE_ENTRIES})
		if(_locale MATCHES "^\\.")
			continue()
		endif()
		if(IS_DIRECTORY "${GETTEXT_PO_PATH}/${_locale}" AND EXISTS "${GETTEXT_PO_PATH}/${_locale}/luanti.po")
			list(APPEND GETTEXT_AVAILABLE_LOCALES "${_locale}")
		endif()
	endforeach()
